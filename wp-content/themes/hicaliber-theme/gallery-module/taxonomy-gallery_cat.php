<?php get_header();
    ...
    $is_page_builder = get_field('gallery_cat_element_builder', 'options');
        ...
        <?php if( $sidebar_left || $sidebar_both ) { get_sidebar($sidebar_left_widget); } ?>
            ...
            <?php else: ?>
                ...
                <?php if($is_page_builder) : ?>
                   ...
                   if(have_rows('gallery_cat_element_builder', 'options')) : 
                    
                        echo '<div class="page-elements">';

                        while ( have_rows('gallery_cat_element_builder', 'options'  ) ) : the_row();
...
<?php
    if( have_rows('gallery_cat_element_builder', 'options') && !$is_template_page_builder ) : 
