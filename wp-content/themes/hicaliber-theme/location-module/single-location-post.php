...
?>
       ...
       <section class="body-content<?php echo $body_content_class; ?>">
          ...
          <?php 
        //Global Elements
        if( _have_rows('lps_sp_elements', 'options') ) : ?>
             <section class="global-element"><?php 
             while ( _have_rows('lps_sp_elements', 'options') ) : the_row(); 
                ...
                if(get_row_layout() == 'related') :
                    ...
                    $elements['pe_posts_header'] = _get_sub_field_value('lps_sp_related_header');
                    $elements['pe_posts_content'] = _get_sub_field_value('lps_sp_related_content_option');
                    $elements['pe_posts_footer'] = false;
                    if(is_array($elements['pe_posts_content'])){
                        $elements['pe_posts_content']['search_filter'] = 'none';
                        $elements['pe_posts_content']['location'] = _get_field_value('link_to_location');
                    }
