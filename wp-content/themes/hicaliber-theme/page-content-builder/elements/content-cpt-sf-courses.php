<?php
    ...
    $section_css = $hs::css_class_helper(
       [ 'page-element', 'listing-element', 'course-element', _get_field_value('display', $page_id),'grid', $grid_layout, _get_field_value('section_classes', $page_id), _get_field_value('theme', $page_id), _get_field_value('element_width', $page_id), _get_field_value('text_alignment', $page_id) ]
    );    
?>
