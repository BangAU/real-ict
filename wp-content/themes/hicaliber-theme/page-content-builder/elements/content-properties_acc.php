<?php
    ...
    $layout = $elements['pe_properties_acc_layout'];
    $PCBPrj = new hcPCBAccProperties();
    ...
    $pcb->setSettings($elements['pe_properties_acc_design']);
    ...
    $pcb->setHeader($elements['pe_properties_acc_header']);
    ...
    $content_options = $elements['pe_properties_acc_content'];    
   ...
   // if( is_array($content_to_display) ? !in_array('button', $content_to_display) : false || !$content_to_display ) $pcb->addClassesTo('section', ['button-hidden']);
    ...
    $button_label = (isset($listing_button_settings['label']) ? $listing_button_settings['label'] : false) ? $listing_button_settings['label'] : 'View Deals';
    ...
    if( class_exists('HI_ACC_TEMP_FUNCTIONS') ) {
        ...
        $results = HI_ACC_TEMP_FUNCTIONS::acc_query( $param );
    }
    ...
    if(  $result_count ) :
        ...
        //$hicBox->setRating( get_field('property_ratings' ) );
