<?php
if (! class_exists ( 'hcPCBAccProperties' )):
class hcPCBAccProperties extends hcPCBContent{    
    ...
    public function __construct(){
        ...
        $this->defaultSectionClasses=["content-box-element property-element listing-element"];
    ...
    public function displayContent(){
        ...
        <div class="cell <?php echo isset($this->classes['hic-box-container']) ? $this->getClassesOf('hic-box-container') : ''; ?>">
            ...
            <div class="hic-box <?php echo isset($this->classes['hic-box']) ? $this->getClassesOf('hic-box') : ''; ?>">
                <div class="property-location">Hawaii, USA</div>
