...
<footer class="footer <?php echo $foooter_layout; ?>" role="contentinfo">
    ...
    <div class="grid-container">
        ...
        <div class="back-to-top-wrap">
            <div id="back-to-top" data-position="<?php echo $b2t_options['position']; ?>"
                data-icon-type="<?php echo $b2t_options['icon_type']; ?>">
                <?php if($b2t_options['tooltip']) : ?>
                <span class="b2t-tooltip"><?php echo $b2t_options['tooltip'] ?></span>
                <?php endif; ?>
                <?php if($b2t_options['icon_type'] == "icon") : ?>
                <span
                    class="b2t-icon"><?php echo $b2t_options['icon'] ? $b2t_options['icon'] : '<i class="far fa-angle-up"></i>'; ?></span>
                <?php elseif($b2t_options['icon_type'] == "image") : ?>
                <span class="b2t-icon"><img
                        src="<?php echo $b2t_options['image'] ? $b2t_options['image'] : get_template_directory_uri() . '/assets/images/arrow-top.png'; ?>"
                        alt="Back to top" /></span>
                <?php endif; ?>
